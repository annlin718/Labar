...
function getReady()
{
	xmlDoc = GetXMLData("faces/LIST0124.xml");	
...
{	
	...
	for(var i = Startcnt;i <= Endcnt;i++)
	{
		...
		else
		{
			...
			if(Grade!="")
			{
				...
				{
					sHTML += "<div id=\"div"+sNo+"\" onClick=\"surprice(this,"+sNo+")\" class=\"divCard\"><img id=\"pic"+sNo+"\" class=\"picCards\" src=\"faces/back2.svg\" /><font id=\"font"+sNo+"\" class=\"fontAward\">"+Grade+"<br><br>"+Title+"<br><font class=\"fontPrice\">"+Price+"</font></font></div>"		
				}
				else
				{
					sHTML += "<div id=\"div"+sNo+"\" onClick=\"surprice(this,"+sNo+")\" class=\"divCard\"><img id=\"pic"+sNo+"\" class=\"picCards\" src=\"faces/back2.svg\" /><font id=\"font"+sNo+"\" class=\"fontAward\"><font class=\"fontGrade\">"+Grade+"</font><br><br>"+Title+"<br><br><font class=\"fontPrice\">"+Price+"</font></font></div>"		
				}
			}
			else
			{
				sHTML += "<div id=\"div"+sNo+"\" onClick=\"surprice(this,"+sNo+")\" class=\"divCard\"><img id=\"pic"+sNo+"\" class=\"picCards\" src=\"faces/back2.svg\" /><font id=\"font"+sNo+"\" class=\"fontAward\">"+Title+" <br></font></div>"		
			}
		}
	}	
	...
	$("#divCards"+page).animate({opacity:"1"},500);
...
function ShowPage(Obj,page)
{
	...
	$(".divCards").css({opacity:"0"});
	$("#divCards"+PrePage).css("z-index","100");
	$("#divCards"+page).css("z-index","200");
	$("#divCards"+page).animate({opacity:"1"},100);
	$("#btn"+page).addClass("btnNow");
	PrePage = page;
}
